...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-[#020202] text-gray-900 font-sans selection:bg-[#0B57D0] selection:text-white">
      <Navbar />
      ...
      <div className="relative pt-32 pb-24 px-4 md:px-6 max-w-7xl mx-auto min-h-[90vh] flex items-center">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 w-full relative z-10">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500">We typically review projects and respond within 2-4 hours during business days.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-[#111] border border-gray-800 flex items-center justify-center flex-shrink-0">
          ...
          >
            <div className="bg-[#0A0A0A] border border-gray-800 rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 relative z-10">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                      <label className="text-sm font-semibold text-gray-400 pl-1">Full Name</label>
                      <input required type="text" placeholder="John Doe" className="w-full bg-[#111] border border-gray-800 rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#0B57D0] focus:ring-1 focus:ring-[#0B57D0] transition-all" />
                    </div>
                    <div className="flex flex-col gap-2">
                      <label className="text-sm font-semibold text-gray-400 pl-1">Work Email</label>
                      <input required type="email" placeholder="john@company.com" className="w-full bg-[#111] border border-gray-800 rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#0B57D0] focus:ring-1 focus:ring-[#0B57D0] transition-all" />
                    </div>
                  </div>

                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-gray-400 pl-1">Company / Project Name</label>
                    <input required type="text" placeholder="Acme Corp" className="w-full bg-[#111] border border-gray-800 rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#0B57D0] focus:ring-1 focus:ring-[#0B57D0] transition-all" />
                  </div>

                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-gray-400 pl-1">Mobile Number</label>
                    <input required type="tel" placeholder="+1 (555) 000-0000" className="w-full bg-[#111] border border-gray-800 rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#0B57D0] focus:ring-1 focus:ring-[#0B57D0] transition-all" />
                  </div>

                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-gray-400 pl-1">Project Details</label>
                    <textarea required placeholder="Tell us about the problem you are trying to solve..." rows={4} className="w-full bg-[#111] border border-gray-800 rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#0B57D0] focus:ring-1 focus:ring-[#0B57D0] transition-all resize-none"></textarea>
                  </div>
